import discord, datetime, asyncio, re, asyncio, json
from discord.ext import commands 
from uwuipy import uwuipy
from discord import Message, File, Embed, User
from headers import Session
from collections import defaultdict
from patches.classes import Perms
from utils.embed import Embed
from patches.classes import Messages, Cache
...
class Messages(commands.Cog): 
    ...
    async def uwulock(self, message: discord.Message):
        ...
        check1 = check = await self.bot.db.fetchrow("SELECT user_id FROM guwulock WHERE user_id = $1", message.author.id)
        if check1: return  
