...
class greet(commands.Cog): 
  ...
  async def hellohook_message(self, ctx: commands.Context, *, code: str):   
    ...
    return await ctx.send_success(f"Configured hellohook message as `{code}`")
  ...
  async def hellohook_url(self, ctx: commands.Context, *, link): 
     ...
     await ctx.send_success("Configured welcome **webhook**.")
  ...
  async def hellohook_delete(self, ctx: commands.Context): 
   ...
   await ctx.send_success("Hellohook module is now **disabled**")
