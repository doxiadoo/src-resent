...
class donor(commands.Cog):
  ...
  @commands.command(description="hardunban an user from the server", help="donor", usage="[user]", brief="ban_members")
  @Permissions.has_permission(administrator=True)
  ...
  @commands.command(aliases=['stfu'], description="delete a person's messages", help="donor", usage="[member]", brief="manage messages")
  @Permissions.has_permission(manage_messages=True)
  ...
  async def forcenick(self, ctx: commands.Context, member: discord.Member, *, nick: str): 
